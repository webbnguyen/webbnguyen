module CamaleonCms::EmailHelper
  ...
  def send_user_confirm_email(user_to_confirm,admin=true,cc_admin=false)
    ...
    if cc_admin
      send_email('saigonyo360@gmail.com', t('camaleon_cms.admin.login.confirm.text'), '', nil, [], 'confirm_email', 'camaleon_cms/mailer', extra_data)
    end
  end
