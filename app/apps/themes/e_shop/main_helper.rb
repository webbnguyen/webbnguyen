module Themes::EShop::MainHelper
  ...
  def e_shop_on_install_theme(theme)
    unless theme.site.nav_menus.where(slug: "eshop_footer_main_menu").present? # verify if theme was installed before
      ...
      menu_item = menu.append_menu_item({label: "BECOME A SHARER", type: "external", link: "#"})
      new_in = menu.append_menu_item({label: "HELP", type: "external", link: "#"})
      new_in = menu.append_menu_item({label: "SAIGONYO 360", type: "external", link: "#"})
      ...
      item = menu.append_menu_item({label: "Saigonyo", type: "external", link: '#'})
      item.append_menu_item({label: "About us", type: "external", link: '#'})
      item.append_menu_item({label: "Policies", type: "external", link: '#'})
      item.append_menu_item({label: "Terms Use", type: "external", link: '#'})
      item.append_menu_item({label: "Privacy", type: "external", link: '#'})
      item.append_menu_item({label: "Careers", type: "external", link: '#'})
      item.append_menu_item({label: "Guidebooks", type: "external", link: '#'})

      item = menu.append_menu_item({label: "Help", type: "external", link: '#'})
      item.append_menu_item({label: "Why Share", type: "external", link: '#'})
      item.append_menu_item({label: "Discover", type: "external", link: '#'})
      item.append_menu_item({label: "Travel Credit", type: "external", link: '#'})
      item.append_menu_item({label: "Economy Sharing", type: "external", link: '#'})
      item.append_menu_item({label: "Saigonyo Citizen", type: "external", link: '#'})
      item.append_menu_item({label: "Brands", type: "external", link: '#'})

      item = menu.append_menu_item({label: "Popular", type: "external", link: '#'})
      item.append_menu_item({label: "Trust & Safety", type: "external", link: '#'})
      item.append_menu_item({label: "Community Center", type: "external", link: '#'})
      item.append_menu_item({label: "Gift Cards", type: "external", link: '#'})
      item.append_menu_item({label: "Responsible Sharing", type: "external", link: '#'})
      item.append_menu_item({label: "Hospitality", type: "external", link: '#'})
      item.append_menu_item({label: "Blog YO", type: "external", link: 'blog-yo'})
